...
function setup() {
    ...
    block1=new Block3(240,425,30,30)
    block2=new Block3(270,425,30,30)
    block3=new Block3(300,425,30,30)
    block4=new Block3(330,425,30,30)
    block5=new Block3(360,425,30,30)
    block6=new Block3(390,425,30,30)
    block7=new Block3(420,425,30,30)
    ...
    block17=new Block3(580,225,30,30)
    block18=new Block3(610,225,30,30)
    block19=new Block3(640,225,30,30)
    block20=new Block3(670,225,30,30)
    block21=new Block3(700,225,30,30)
